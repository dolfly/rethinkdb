...
RT_CXXFLAGS := $(CXXFLAGS) $(RE2_CXXFLAGS) $(V8_INCLUDE) $(PROTOBUF_INCLUDE)
...
$(BUILD_DIR)/$(SERVER_EXEC_NAME): $(SERVER_EXEC_OBJS) | $(BUILD_DIR)/. $(TCMALLOC_MINIMAL_LIBS_DEP) $(V8_LIBS_DEP) $(PROTOBUF_LIBS_DEP)
	$P LD $@
